...
export const adminNavigation = [
  ...
  { label: 'Contenido Web', to: '/admin/contenido', icon: Images },
  ...
  { label: 'Órdenes', to: '/admin/ordenes', icon: BriefcaseBusiness },
  { label: 'Inventario', to: '/admin/inventario', icon: PackageSearch },
  { label: 'Facturación', to: '/admin/facturacion', icon: HandCoins },
...
export const clientNavigation = [
  ...
  { label: 'Mis Órdenes', to: '/portal/ordenes', icon: BriefcaseBusiness },
